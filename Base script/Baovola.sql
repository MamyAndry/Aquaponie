...
--------------------------------------------------------------------------------------- DATA  ---------------------------------------------------------------------------------
    ...
    ('FIP4','FISH0002','POND0004',FALSE,48,TO_DATE('02-25-2015', 'MM-dd-YYYY')),
    ('FIP1','FISH0001','POND0001',TRUE,60,TO_DATE('01-15-2021', 'MM-dd-YYYY')),
    ('FIP2','FISH0001','POND0002',FALSE,58,TO_DATE('01-15-2021', 'MM-dd-YYYY')),
    ('FIP3','FISH0002','POND0003',TRUE,52,TO_DATE('01-15-2021', 'MM-dd-YYYY')),
    ('FIP4','FISH0002','POND0004',FALSE,70,TO_DATE('01-15-2021', 'MM-dd-YYYY')),
    ('FIP1','FISH0001','POND0001',TRUE,45,TO_DATE('02-19-2022', 'MM-dd-YYYY')),
    ('FIP2','FISH0001','POND0002',FALSE,50,TO_DATE('02-19-2022', 'MM-dd-YYYY')),
    ('FIP3','FISH0002','POND0003',TRUE,55,TO_DATE('02-19-2022', 'MM-dd-YYYY')),
    ('FIP4','FISH0002','POND0004',FALSE,47,TO_DATE('02-19-2022', 'MM-dd-YYYY')),
    ('FIP1','FISH0001','POND0001',TRUE,60,TO_DATE('03-01-2023', 'MM-dd-YYYY')),
